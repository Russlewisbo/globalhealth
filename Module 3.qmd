...
As of December 30, 2022, the [WHO Coronavirus (COVID-19) Dashboard](https://covid19.who.int/) reports over 663 million cumulative cases and 6.7 million deaths due to SARS-CoV-2. Over 200 cases new cases are still reported daily. Beyond direct illness and death, COVID-19 has spawned countless repercussions from mental health to a global supply chain breakdown. Some issues were predictable and some impossible to foresee in the area of global health, for example:

-   TB deaths also climbed worldwide for the first time in a decade, according to [a October 14, 2022 WHO report](https://www.who.int/news/item/14-10-2021-tuberculosis-deaths-rise-for-the-first-time-in-more-than-a-decade-due-to-the-covid-19-pandemic) that directly tied the increase to the pandemic.
...
According to the WHO, over 11 billion people must be vaccinated against COVID-19. As of December 2022, 71.8% of the world population has received at least one dose of a COVID-19 vaccine. However, vaccination rates still lag in Africa [@fig-whodashboard].

::: {#fig-whodashboard}
<iframe src="https://covid19.who.int/?mapFilter=vaccinations" loading="lazy" style="width: 100%; height: 600px; border: 0px none;">
...
-   Ultimately, these goals meant that although COVAX promised 100 million doses by the end of March, this goal was not reached until 6 July. By mid-August of 2021, COVAX delivered 200 million vaccine doses to nearly 140 countries instead of the 600 million doses initially projected. In regions like sub-Saharan Africa, health officials are still struggling to get their hands on vaccines to protect workers on the front lines of the pandemic [UNICEF COVID-19 vaccine dashboard](https://www.unicef.org/supply/covid-19-market-dashboard). [Click here](https://www.youtube.com/watch?v=87D676W6XOU&feature=youtu.be) to see a short You Tube video on vaccine roll-out efforts.
...
Generic competition is making a difference in fostering lower prices and improving treatment coverage. Generic partners have distributed **49.71 million** patient-years of HIV and hepatitis C products, saving international purchasers **USD 920 million** (January 2012-December 2020)[@fig-mpp3].

::: {#fig-mpp3}
![](images/MMP_outcomes.png){width="600"}

Impact of the Medicines Patent Pool. Source: medicinespatientpool.org
:::
...
Sources of counterfeit drugs. Source Financial Times
:::
...
::: callout-note
## The human cost of counterfeit medications
...
<iframe src="https://slides.com/russelllewis/module-3-antibiotic-and-diagnostic-test-availability-affordabilty-and-access-lessons-from-the-covid-19-pandemic/embed" width="576" height="420" title="Module 3: Antibiotic and diagnostic test availability, affordabilty and access-Lessons from the COVID-19 pandemic" scrolling="no" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen>
